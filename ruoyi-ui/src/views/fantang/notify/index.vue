<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="消息范围" prop="scope">
        <el-input
      ...
      <el-form-item label="消息内容" prop="messageBody">
        <el-input
          v-model="queryParams.messageBody"
          placeholder="请输入消息内容"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="阅读标志" prop="readFlag">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['fantang:notify:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="消息范围" prop="scope">
          <el-input v-model="form.scope" placeholder="请输入消息范围" />
        </el-form-item>
        <el-form-item label="消息内容" prop="messageBody">
          <el-input v-model="form.messageBody" placeholder="请输入消息内容" />
        </el-form-item>
      </el-form>
...
<script>
import { listNotify, getNotify, delNotify, addNotify, updateNotify, exportNotify } from "@/api/fantang/notify";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除系统信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有系统信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
