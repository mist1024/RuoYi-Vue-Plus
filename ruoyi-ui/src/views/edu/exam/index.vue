<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="编号" prop="examNo">
        <el-input
    ...
    <el-table v-loading="loading" :data="examList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="日期" align="center" prop="id" v-if="false"/>
      <el-table-column label="编号" align="center" prop="examNo" />
      <el-table-column label="名称" align="center" prop="examName" />
      <el-table-column label="简称" align="center" prop="examShortName" />
      <el-table-column label="日期" align="center" prop="examDate" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="编号" prop="examNo">
          <el-input v-model="form.examNo" placeholder="请输入编号" />
        </el-form-item>
        <el-form-item label="名称" prop="examName">
...
<script>
import { listExam, getExam, delExam, addExam, updateExam, exportExam } from "@/api/edu/exam";
