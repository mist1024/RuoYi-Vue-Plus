...
public interface ISysDictTypeService {
    ...
    TableDataInfo<SysDictTypeVo> selectPageDictTypeList(SysDictTypeBo bo, PageQuery pageQuery);
     ...
     * @return 字典类型集合信息
     */
    List<SysDictTypeVo> selectDictTypeList(SysDictTypeBo bo);
     ...
     * @return 结果
     */
    String checkDictTypeUnique(SysDictTypeBo bo);
}
