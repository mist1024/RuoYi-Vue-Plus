  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>wild-vue-plus后台管理框架</h2>
        <p>
          wild-vue-plus 是基于 wild-Vue 针对 分布式集群 场景升级(不兼容原框架)
          <br/>
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/JavaLionLi/wild-vue-plus')"
            >访问码云</el-button
          >
          <el-button
            type="primary"
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://github.com/JavaLionLi/wild-vue-plus')"
          >访问GitHub</el-button
          >
        </p>
      </el-col>
          ...
          <el-collapse accordion>
            ...
            <el-collapse-item title="v3.3.0 - 2021-10-29">
              <ol>
                ...
                <li>add [重大更新] 增加 wild-job 任务调度模块(基于xxl-job)</li>
            ...
            <el-collapse-item title="v2.1.0 - 2021-5-17">
              <ol>
                ...
                <li>remove 移除wild自带服务监控(Admin已全部包含)</li>
              </ol>
            </el-collapse-item>
            ...
            <el-collapse-item title="v1.0.0 - 2021-5-10">
              <ol>
                <li>wild-vue-plus 后台管理系统正式发布</li>
                ...
                <li>集成 Hutool 5.X 并重写wild部分功能</li>
